...
Learned how event-driven systems automatically notify multiple users or systems after actions occur.

---

## Command-Line Interface

Learned why developers use CLI tools to improve workflow speed and efficiency.
...
When a student completes fee payment, the system should automatically:
- Notify the student
- Update payment records
- Inform the finance department

This allows multiple systems and users to receive updates instantly.

---

# CLI Reflection

Developers prefer command-line tools because they are faster and help automate repetitive tasks. CLI tools also improve productivity and simplify development workflows.

---

# Search Reflection

Fast and accurate search is important in enterprise systems because organizations store large amounts of data. Good search functionality helps users quickly access required information and improves efficiency.

---

# One Doubt / Question

How do Apex Triggers and Platform Events work together in real-time enterprise applications?

---

# Key Learnings

- Understood enterprise search systems.
- Learned basic event-driven architecture concepts.
- Learned the purpose of Salesforce CLI tools.
...
![Trailhead Screenshot](screenshots/light-day-progress.png)
